class PurchaseRecordsController < ApplicationController
  ...
  params.require(:purchase_records_address).permit(:post_code, :prefecture_id, :city , :street_address, :building_name, :phone_number, :item_id, :user_id).merge(user_id: current_user.id, token: params[:token])
  end
